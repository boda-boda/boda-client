...
import OuterCareGiverDetail from '../../components/outer-care-giver-detail';
    ...
    <>
      ...
      <Layout>
        <>
          ...
          />
          <Category list={['홈', '요양보호사 검색', '요양보호사 세부정보']} />
          <S.CareGiverDetailPage>
            <OuterCareGiverDetail />
          </S.CareGiverDetailPage>
        </>
      </Layout>
    </>
