...
export const WORKING_STATE = ['재직', '퇴사', '컨택'];
...
export const WORKER_WOMAN_SMALL_IMAGE_URL =
  'https://dolbom.s3.ap-northeast-2.amazonaws.com/newFiles/09861f8d-2bce-49d0-87cc-8500eb018801_%E1%84%8B%E1%85%A7%E1%84%89%E1%85%A5%E1%86%BC%E1%84%8B%E1%85%AD%E1%84%8B%E1%85%A3%E1%86%BC%E1%84%87%E1%85%A9%E1%84%92%E1%85%A9%E1%84%89%E1%85%A1.png';

export const WORKER_MAN_SMALL_IMAGE_URL =
  'https://dolbom.s3.ap-northeast-2.amazonaws.com/newFiles/5c4564c4-d40c-43eb-84b0-3d21af0c0cd0_%E1%84%82%E1%85%A1%E1%86%B7%E1%84%89%E1%85%A5%E1%86%BC%E1%84%8B%E1%85%AD%E1%84%8B%E1%85%A3%E1%86%BC%E1%84%87%E1%85%A9%E1%84%92%E1%85%A9%E1%84%89%E1%85%A1.png';

export const RECIPIENT_WOMAN_SMALL_IMAGE_URL =
  'https://dolbom.s3.ap-northeast-2.amazonaws.com/newFiles/1094bbe9-02b8-4c42-8d0a-23f2af8accea_%E1%84%8B%E1%85%A7%E1%84%89%E1%85%A5%E1%86%BC%E1%84%89%E1%85%AE%E1%84%80%E1%85%B3%E1%86%B8%E1%84%8C%E1%85%A1.png';
...
export const CARE_WORKERS_DEMO = [
  {
    id: 0,
    name: '김요양',
    gender: '여성',
    ...
    profile: WORKER_WOMAN_SMALL_IMAGE_URL,
    zipCode: '00000',
    address: '서울특별시 00구 00로 00',
    ...
    careWorkerMetas: [
      ...
      { type: 'Capability', key: '기저귀' },
      { type: 'Capability', key: '재활' },
      { type: 'Capability', key: '가사' },
      { type: 'Capability', key: '치매' },
      { type: 'Capability', key: '간호조무사' },
      { type: 'Religion', key: '무교' },
    ],
    careWorkerSchedules: [
      { day: '월', startAt: '9:00', endAt: '12:00' },
      { day: '화', startAt: '9:00', endAt: '12:00' },
      { day: '수', startAt: '9:00', endAt: '12:00' },
  ...
  },
  {
    ...
    careWorkerAreas: [
      { city: '서울특별시', gu: '강남구', dong: '개포동' },
      { city: '서울특별시', gu: '강남구', dong: '논현동' },
      { city: '서울특별시', gu: '강남구', dong: '대치동' },
      { city: '서울특별시', gu: '강남구', dong: '도곡동' },
      { city: '서울특별시', gu: '강남구', dong: '삼성동' },
    ],
    careWorkerMetas: [
      { type: 'Capability', key: '가사' },
      { type: 'Capability', key: '입주' },
      { type: 'Capability', key: '휠체어' },
      { type: 'Religion', key: '불교' },
    ],
  ...
  },
  {
    ...
    birthDay: '19600101',
    phoneNumber: '010-0000-0000',
    profile: WORKER_MAN_SMALL_IMAGE_URL,
    zipCode: '00000',
    address: '서울특별시 00구 00로 00',
    detailAddress: '000동 0000호',
    description: '매우 성실하시고 체력이 좋으시다.  수급자 만족도 높은 편',
  ...
  },
  {
    ...
    careWorkerAreas: [
      { city: '서울특별시', gu: '서대문구', dong: '남가좌동' },
      { city: '서울특별시', gu: '서대문구', dong: '냉천동' },
      { city: '서울특별시', gu: '서대문구', dong: '대신동' },
      { city: '서울특별시', gu: '서대문구', dong: '대현동' },
    ],
    careWorkerMetas: [
      { type: 'Capability', key: '석션' },
      { type: 'Capability', key: '피딩' },
    ...
    careWorkerSchedules: [
      { day: '월', startAt: '14:00', endAt: '17:00' },
      { day: '수', startAt: '14:00', endAt: '17:00' },
      { day: '금', startAt: '14:00', endAt: '17:00' },
    ],
  },
  {
    id: 4,
    ...
    careWorkerSchedules: [
      { day: '월', startAt: '14:00', endAt: '17:00' },
      { day: '화', startAt: '14:00', endAt: '17:00' },
      { day: '수', startAt: '14:00', endAt: '17:00' },
      { day: '목', startAt: '14:00', endAt: '17:00' },
      { day: '금', startAt: '14:00', endAt: '17:00' },
    ],
    careWorkerCareers: [
      { workplace: '서대문구 재가센터', recipient: '김수급', duration: '2019.03 ~ 2020.5' },
    ],
  },
  {
    id: 5,
    ...
    careWorkerAreas: [
      ...
      { city: '서울특별시', gu: '은평구', dong: '대조동' },
      { city: '서울특별시', gu: '은평구', dong: '불광동' },
      { city: '서울특별시', gu: '은평구', dong: '진관동' },
      { city: '서울특별시', gu: '서대문구', dong: '' },
    ],
    careWorkerMetas: [
      { type: 'Capability', key: '석션' },
      { type: 'Capability', key: '피딩' },
      { type: 'Capability', key: '휠체어' },
      { type: 'Religion', key: '기독교' },
    ],
    careWorkerSchedules: [
      { day: '토', startAt: '9:00', endAt: '17:00' },
      { day: '일', startAt: '9:00', endAt: '17:00' },
    ],
  },
  {
    id: 6,
  ...
  },
  {
    ...
    careWorkerCareers: [
      { workplace: '서대문구 재가센터', recipient: '김수급', duration: '2019.03 ~ 2020.05' },
      { workplace: '서대문구 재가센터', recipient: '어르신', duration: '2019.09 ~ 2020.09' },
      { workplace: '서대문구 재가센터', recipient: '최수급', duration: '2019.12 ~ 2021.02' },
      { workplace: '은평구 재가센터', recipient: '김수급', duration: '2019.01 ~ 2021.03' },
    ],
  },
  {
    id: 8,
    ...
    careWorkerSchedules: [],
    careWorkerCareers: [
      { workplace: '강남구 재가센터', recipient: '김수급', duration: '2019.03 ~ 2020.05' },
      { workplace: '강남구 재가센터', recipient: '어르신', duration: '2019.09 ~ 2020.09' },
      { workplace: '서초구 재가센터', recipient: '최수급', duration: '2019.12 ~ 2021.02' },
      { workplace: '서초구 재가센터', recipient: '김수급', duration: '2019.01 ~ 2021.03' },
    ],
  },
  {
    id: 9,
  ...
  },
  {
    ...
    careWorkerSchedules: [
      { day: '월', startAt: '15:00', endAt: '18:00' },
      { day: '화', startAt: '15:00', endAt: '18:00' },
      { day: '수', startAt: '15:00', endAt: '18:00' },
      { day: '목', startAt: '15:00', endAt: '18:00' },
      { day: '금', startAt: '15:00', endAt: '18:00' },
    ],
  },
];
